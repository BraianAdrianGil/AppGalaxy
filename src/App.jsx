...
function App() {
  ...
  const [currentBackgroundImage, setCurrentBackgroundImage] = useState(
    Math.floor(Math.random() * spaceImages.length)
  );
  ...
  return (
    <div
      className="App"
      style={{ backgroundImage: `url(${spaceImages[currentBackgroundImage]})` }}
    >
      <h1>INFOGALAXY</h1>
      ...
      <p className="source__of__information">
        <span>Fuente: </span>
        <a href="{currentData.author}" target="_blank">
          {currentData.author}
        </a>
      </p>
    </div>
